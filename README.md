...
| [uv](https://github.com/astral-sh/uv) | astral-sh/uv | 0.7.3 | May 14, 2025 | linux (amd64, arm64) |
...
<div align='center'><h3>📦 72 Tools | 💾 913.1 MB Total Size</h3></div>

| Tool | Total Size | Avg Size per Architecture |
| :--- | :-------- | :------------------------ |
| difft | 175.14 MB | 87.57 MB |
| lnav | 122.06 MB | 61.03 MB |
| uv | 74.51 MB | 37.26 MB |
